...
ah = ismember(txtcell,{'ah', 'above', 'bud', 'buddy', 'buffed', 'bun', 'bus', 'busk', 'bust', 'buyDougie', 'Dougie', 'Duggie', 'funny',...
...
ow = ismember(txtcell,{'ow' 'o' 'oh' 'blow' 'bode' 'foam' 'pope' 'show' 'shore' 'so' 'sore'});
