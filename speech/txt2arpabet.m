...
aa = ismember(txtcell,{'aa', ...
    'ah' 'a' 'ba' 'bah' 'Bobby' 'bobbyfunny' 'bod' 'bot' 'boss' 'buyBobby' 'car' 'carbonate' 'cod' 'copper' 'czar' 'dock' 'gar' 'god' 'ka' 'llama', ...
...
ae = ismember(txtcell,{'ae',...
    'add', 'ad', 'bad', 'ban', 'bat', 'batA', 'batB', 'black', 'capper', 'cat', 'dad', 'fast' 'gapper',...
    'pat', 'rad', 'sad', 'Sammy' 'sapper', 'sat', 'tapper', 'yallow', 'zapper'});
ah = ismember(txtcell,{'ah', 'above', 'bud', 'buddy', 'buffed', 'bun', 'bus', 'busk', 'bust', 'buyDougie', 'Dougie', 'Duggie', 'fun', 'funny',...
    'muffins', 'musk', 'must', 'puppy', 'somebun' 'thumb' 'LThumb' 'UThumb'});
...
eh = ismember(txtcell, {'eh', ... 
    ...
    'said','scent','sekt','sent','set','seven','sever','shed','Ted','ted','ten','yellow', 'zen'}); 
ey = ismember(txtcell,{'ey' 'abate' 'bayed' 'beta' 'caper' 'eI' 'fei1' 'fei2' 'fei3' 'fei4' 'fei5' 'grain' 'Mary' 'shaper'});
ih = ismember(txtcell,{'ih' 'I' 'bid' 'bin' 'bink' 'bit' 'LFinger' 'RFinger' 'finger' 'rid' 'grin' 'yillow' 'pink' 'pit' 'sin' 'sip' 'sipper' 'sit' 'shin' 'ship' 'tipper' 'zipper' 'lion', ...
...
ow = ismember(txtcell,{'ow' 'o' 'oh' 'blow' 'bode' 'foam' 'pope' 'show' 'shore' 'slow' 'so' 'sore'});
