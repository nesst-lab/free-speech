...
aa = ismember(txtcell,{'aa', ...
    'ah' 'a' 'ba' 'bah' 'Bobby' 'bod' 'bot' 'boss' 'car' 'carbonate' 'cod' 'copper' 'czar' 'dock' 'gar' 'god' 'ka' 'llama', ...
...
ah = ismember(txtcell,{'ah', 'above', 'bud', 'buffed', 'bun', 'bus', 'busk', 'bust', 'Dougie', 'musk', 'must', 'puppy'});
...
eh = ismember(txtcell, {'eh', ... 
    ...
    'fait','fed','glen','guest','hais','head','headH','headL','headM', 'headrest', 'hen', 'level','meta',...
