...
ah = ismember(txtcell,{'ah', 'above', 'bud', 'buddy', 'buffed', 'bun', 'bus', 'busk', 'bust', 'buyDougie', 'Dougie', 'Duggie', 'funny',...
    'muffins', 'musk', 'must', 'puppy', 'somebun' 'thumb'});
...
ih = ismember(txtcell,{'ih' 'I' 'bid' 'bin' 'bink' 'bit' 'finger' 'rid' 'grin' 'yillow' 'pink' 'pit' 'sin' 'sip' 'sipper' 'sit' 'shin' 'ship' 'tipper' 'zipper' 'lion', ...
